...
public class Tank {
    ...
    private static int k1 = 0, k2 = 0, k3 = 0, r1 = 0, r2 = 0;
    ...
    public static void MTank() {
        ...
        System.out.print("length? (please choose a number between 2 and 5) l1=");
        l1 = input.nextInt();
        while (l1 > 5 || l1 < 2) {
            System.out.println("Error!");
            System.out.print("l1=");
        ...
        while ((l1 - x1 > 1 && s1 == 2) || (l1 + y1 > 10 && s1 == 4) || (l1 - y1 > 1 && s1 == 3)
                || (l1 + x1 > 10 && s1 == 1)) {
            System.out.println("Error!");
            System.out.print("s1=");
            s1 = input.nextInt();
        ...
        System.out.print("length? (please choose a number between 2 and 5) l2=");
        l2 = input.nextInt();
        while (l2 > 5 || l2 < 2) {
            System.out.println("Error!");
            System.out.print("l2=");
        ...
        while ((l2 - x2 > 1 && s2 == 2) || (l2 + y2 > 10 && s2 == 4) || (l2 - y2 > 1 && s2 == 3)
                || (l2 + x2 > 10 && s2 == 1)) {
            System.out.println("Error!");
            System.out.print("s2=");
            s2 = input.nextInt();
        ...
        System.out.print("length? (please choose a number between 2 and 5) l3=");
        l3 = input.nextInt();
        while (l3 > 5 || l3 < 2) {
            System.out.println("Error!");
            System.out.print("l3=");
        ...
        while ((l3 - x3 > 1 && s3 == 2) || (l3 + y3 > 10 && s3 == 4) || (l3 - y3 > 1 && s3 == 3)
                || (l3 + x3 > 10 && s3 == 1)) {
            System.out.println("Error!");
            System.out.print("s3=");
            s3 = input.nextInt();
        ...
        System.out.print("length? (please choose a number between 2 and 5) l4=");
        l4 = input.nextInt();
        while (l4 > 5 || l4 < 2) {
            System.out.println("Error!");
            System.out.print("l4=");
        ...
        while ((l4 - x4 > 1 && s4 == 2) || (l4 + y4 > 10 && s4 == 4) || (l4 - y4 > 1 && s4 == 3)
                || (l4 + x4 > 10 && s4 == 1)) {
            System.out.println("Error!");
            System.out.print("s4=");
            s4 = input.nextInt();
        ...
        System.out.print("length? (please choose a number between 2 and 5) l5=");
        l5 = input.nextInt();
        while (l5 > 5 || l5 < 2) {
            System.out.println("Error!");
            System.out.print("l5=");
        ...
        while ((l5 - x5 > 1 && s5 == 2) || (l5 + y5 > 10 && s5 == 4) || (l5 - y5 > 1 && s5 == 3)
                || (l5 + x5 > 10 && s5 == 1)) {
            System.out.println("Error!");
            System.out.print("s5=");
            s5 = input.nextInt();
